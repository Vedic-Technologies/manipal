...
<div className=" flex  " >
      ...
      <div className="  " ><img className=" h-20 w-60 ml-6 mt-4" src={Prospin} alt="" />  </div>
<div className=" shadow-transparent  from-transparent border-[0.1px] border-black shadow-2xl backdrop-sepia-2 bg-white/20 ... h-[350px] w-[290px] rounded-lg absolute mt-[180px] ml-4 " >
      ...
      >
        ...
        >
          Log in
        </button>) : (<button className="bg-[#50A150] pt-1 pb-2 px-10 text-white font-sans tracking-tight mb-3 rounded-[30px] text-lg"
          style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
    ...
    <span className="sr-only">Loading...</span>
      ...
      <div className="mt-36 absolute" >  <img src={manipal} alt=""  /> </div>
<div  className=" w-[22rem]  mt-[13rem]"> <img src={center} alt=""  /></div>
      </div>
